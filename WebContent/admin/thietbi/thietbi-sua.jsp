    ...
    <div class="container-fluid">
      ...
      <form action="" method="">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="ma">Mã <span style="color:red">(*)</span></label>
                <input class="form-control" type="text" name="ma">
              </div>
              <div class="col-md-6">
                <label for="ngayNhapThietBi">Ngày nhập thiết bị</label>
                <input class="form-control" type="date" name="ngayNhapThietBi">
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <label for="maSoSeri">Mã số Seri<span style="color:red">(*)</span></label>
